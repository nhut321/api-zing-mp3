...
router.post(
  "/create",
  upload.fields([
    { name: "src_music", maxCount: 1 },
    { name: "image_music", maxCount: 1 },
  ]),
  authorizationToken,
  musicController.CREATE_MUSIC
);
router.put(
  "/edit",
  upload.fields([
